...
class SpecifyWinnerWeeklyTest extends TestCase
{
    public function setUp(): void
    {
        ...
        Participant::factory(['competition_id' => $this->competitionA->id, 'competition_phone_line_id' => $this->competitionA->phoneLines()->first()->id, 'created_at' => '2024-10-02 09:00:00', 'competition_draw_id' => $this->drawOne->id])->count(10)->create();
        ...
        Participant::factory(['competition_id' => $this->competitionA->id, 'competition_phone_line_id' => $this->competitionA->phoneLines()->first()->id, 'created_at' => '2024-10-09 09:00:00', 'competition_draw_id' => $this->drawTwo->id])->count(10)->create();
        ...
        Participant::factory(['competition_id' => $this->competitionA->id, 'competition_phone_line_id' => $this->competitionA->phoneLines()->first()->id, 'created_at' => '2024-10-16 09:00:00', 'competition_draw_id' => $this->drawThree->id])->count(10)->create();
        ...
        Participant::factory(['competition_id' => $this->competitionA->id, 'competition_phone_line_id' => $this->competitionA->phoneLines()->first()->id, 'created_at' => '2024-10-22 09:00:00', 'competition_draw_id' => $this->drawFour->id])->count(10)->create();
