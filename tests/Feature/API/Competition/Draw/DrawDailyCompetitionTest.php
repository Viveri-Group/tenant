...
class DrawDailyCompetitionTest extends TestCase
{
    public function setUp(): void
    {
        ...
        $this->participantB = Participant::factory([ //should have competition_draw_id of 5th draw
            'competition_id' => $this->competitionA->id,
            'competition_phone_line_id' => $this->competitionA->phoneLines()->first()->id,
            'call_start' => '2024-01-06 15:20:00'
        ])->create();

        $this->participantC = Participant::factory([ //should have competition_draw_id of 7th draw
            'competition_id' => $this->competitionA->id,
            'competition_phone_line_id' => $this->competitionA->phoneLines()->first()->id,
            'call_start' => '2024-01-09 17:10:00'
        ])->create();

        $this->participantD = Participant::factory([ //should have competition_draw_id of 10th draw
            'competition_id' => $this->competitionA->id,
            'competition_phone_line_id' => $this->competitionA->phoneLines()->first()->id,
            'call_start' => '2024-01-14 15:00:00'
        ])->create();

        $this->participantE = Participant::factory([ //should have competition_draw_id of 20th draw
            'competition_id' => $this->competitionA->id,
            'competition_phone_line_id' => $this->competitionA->phoneLines()->first()->id,
    ...
    public function test_running_draw()
    {
        ...
        $this->assertCount(22, $competitionDraws = CompetitionDraw::all());
        ...
        $this->assertSame($this->participantB->competition_draw_id, $competitionDraws->get(4)->id);
        $this->assertNotNull($this->participantB->drawn_at);

        $this->participantC->refresh();
        $this->assertSame($this->participantC->competition_draw_id, $competitionDraws->get(6)->id);
        $this->assertNotNull($this->participantC->drawn_at);

        $this->participantD->refresh();
        $this->assertSame($this->participantD->competition_draw_id, $competitionDraws->get(9)->id);
        $this->assertNotNull($this->participantD->drawn_at);

        $this->participantE->refresh();
        $this->assertSame($this->participantE->competition_draw_id, $competitionDraws->get(19)->id);
    ...
    public function test_running_draw_twice()
    {
        ...
        $this->assertCount(22, CompetitionDraw::all());
